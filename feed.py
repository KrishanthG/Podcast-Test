...
channel_ele=xml_tree.SubElement(rss_element,'channel')
...
xml_tree.SubElement(channel_ele,'itunes:image',{'href':link_prefix+yaml_data['image']})
xml_tree.SubElement(channel_ele,'title').text=yaml_data['title']
xml_tree.SubElement(channel_ele,'link').text=link_prefix

xml_tree.SubElement(channel_ele,'itunes:category',{'text':yaml_data['category']})


for item in yaml_data['item']:
    item_element = xml_tree.SubElement(channel_ele,'item')
    ...
    enclosure = xml_tree.SubElement(item_element,'encloser',{
